...
const BlogPostItem: React.FC<BlogPost> = ({ title, category, date, url}) => {
    const details = [
        { text: title, className: 'basis-3/5 text-sm font-normal' },
        { text: category, className: 'basis-0.75/5 text-sm font-light text-zinc-400' },
        { text: date, className: 'basis-0.25/5 text-sm font-light text-zinc-400' }
